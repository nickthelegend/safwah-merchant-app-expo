// AsyncStorage-backed storage adapter for Reown AppKit.
// Ported from molfi-expo-app — lets AppKit persist the WalletConnect session so the
// merchant's wallet stays connected across app restarts.
